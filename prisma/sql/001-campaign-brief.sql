-- Migracion ADITIVA para la base de PRODUCCION.
-- Crea el enum BriefStatus y la tabla CampaignBrief.
--
-- Generada con: prisma migrate diff --from-url <produccion> --to-schema-datamodel
-- y depurada A MANO para eliminar los DROP TABLE de AppSetting y UserSetting:
-- esas tablas existen en produccion (12 y 1 filas) pero no en schema.prisma,
-- por lo que un "prisma db push" las borraria.
--
-- NO ejecutar "prisma db push" contra produccion. Aplicar solo este archivo.
